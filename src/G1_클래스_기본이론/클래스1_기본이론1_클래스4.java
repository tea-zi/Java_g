...
public class 클래스1_기본이론1_클래스4 {
	public static void main(String[] args) {
		...
		String[][] memberList = { { "7369", "SMITH", "CLERK", "7902", "17-12-1980", "800", "0", "20" },
		...
		/*
		 * { 7369, "SMITH", "CLERK", 7902, "17-12-1980", 800, 0, 20 } { 7499, "SMITH",
		 * "CLERK", 7698, "17-12-1980", 1600, 300, 30 } { 7521, "SMITH", "CLERK", 7698,
		 * "17-12-1980", 1250, 500, 30 }
		 */
